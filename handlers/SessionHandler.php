...
use fantomx1\iohandlers\handlers\AbstractHandler;

use fantomx1\iohandlers\adapters\SessionAdapter;
 ...
 * @package fantomx1
 */
class SessionHandler extends AbstractHandler implements InputAdapterInterface
{
    ...
    public static function getAdapter()
    {
        if (!isset(static::$adapter)) {
            static::$adapter = new SessionAdapter();
        }
